...
public class BioskopABC {
    public static void main(String[] args) {
        Film film1 = new Film("Avengers: Endgame", "Action", "18:00", 50000);
        Film film2 = new Film("Frozen II", "Animation", "14:00", 40000);
        Film film3 = new Film("Joker", "Drama", "20:00", 45000);
        
        Studio studio1 = new Studio(1, film1);
        Studio studio2 = new Studio(2, film2);
        Studio studio3 = new Studio(3, film3);
        
        Tiket tiket1 = new Tiket(film1, studio1, 10, "Budi");
        Tiket tiket2 = new Tiket(film2, studio2, 5, "Ani");
        Tiket tiket3 = new Tiket(film3, studio3, 15, "Dono");
